...
import io.github.lucianodacunha.domain.Pet;
...
public class PetService {
    ...
    public PetService(ClienteWeb clienteWeb){
        this.clienteWeb = clienteWeb;
    }
    public boolean importarPetsDoAbrigo() throws IOException,
        ...
        while ((line = reader.readLine()) != null) {
            ...
            HttpResponse<String> response = clienteWeb.post(uri, pet);
    ...
    public boolean listarPetsDoAbrigo() throws IOException,
            InterruptedException {
        System.out.println("Digite o id ou nome do abrigo:");
        String idOuNome = new Scanner(System.in).nextLine();
        ...
        for (Pet pet : petList) {
            System.out.println(pet.getId() + " - " + pet.getTipo() + " - " +
