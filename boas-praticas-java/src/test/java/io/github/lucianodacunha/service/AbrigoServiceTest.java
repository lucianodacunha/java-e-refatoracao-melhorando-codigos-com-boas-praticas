...
public class AbrigoServiceTest {
    ...
    private ClienteWeb clienteWeb = mock(ClienteWeb.class);
    private AbrigoService abrigoService = new AbrigoService(clienteWeb);
    ...
    public void deveVerificarSeDispararRequisicaoGetSeraChamado()
        ...
        when(clienteWeb.get(anyString())).thenReturn(response);
